...
public class SickLeave extends Activity implements View.OnClickListener {
    EditText mailid,ename,ecause,days,from,sign,redate;
    String mail,name,cause,day,frm,si,rdt;
    Button obtn;
    ...
    public void onClick(View view) {
        ...
        String message = "Dear " + name + ", \n\n"
                ...
                + "\n\n" + "I am writing this letter to officially inform about my illness and request for a sick leave ."
                + "I would kindly request you to grant me leave w.e.f " + frm + ". I would be reporting back on " + rdt
                + "\n\n Thanks and Regards "
                + "\n" + " " + si;
            if ( !mail.isEmpty() && !name.isEmpty() && !cause.isEmpty() && !day.isEmpty() && !frm.isEmpty() && !si.isEmpty() && !rdt.isEmpty() ) {
